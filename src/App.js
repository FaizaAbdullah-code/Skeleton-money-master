          ...
          <div className="container">
            <div className="row m-3">
              <div class="col-sm-5 my-auto">
                <img src={logo} width="20%" height="80%" className="imgToken" alt="" loading="lazy" />
                <h4 className="text-center headingToken mt-4">Buy</h4>
                <p className="text-center mt-4 text-white">14% Slipage</p>
              </div>
              <div className="col-sm-2 justify-content-center d-flex">
                <h1 className="head my-auto">Tokenomics</h1>
              </div>
              <div className="col-sm-5 flex-column justify-content-center d-flex">
                <img src={logo} width="20%" height="80%" alt="" className="imgToken" loading="lazy" />
                <h4 className="headingToken text-center mt-4">Sell</h4>
                <p className="text-center mt-4 text-white">16% slipage</p>
              </div>
            </div>
            <h2 className="line text-white">$SAFTI</h2>
            <div className="row m-3">
              <div class="col-sm-5 my-auto">
                <h4 className="text-center headingToken">Auto-Liquidity System (ALS)</h4>
                <p className="text-center mt-4 text-white">4% of order fees return to liquidity</p>
              </div>
              <div className="col-sm-2 justify-content-center d-flex">
                <img src={logo} width="30%" height="80%" alt="" loading="lazy" />
              </div>
              <div className="col-sm-5 flex-column justify-content-center d-flex">
                <h4 className="headingToken text-center">Auto-Liquidity System (ALS)</h4>
                <p className="text-center mt-4 text-white">4% of order fees return to liquidity</p>
              </div>
            </div>
            <h2 className="line text-white">$SAFTI</h2>
            <div className="row m-3">
              <div class="col-sm-5 my-auto">
                <h4 className="text-center headingToken">Risk Free Value (RFV)</h4>
              ...
              <div className="col-sm-5 flex-column justify-content-center d-flex">
                <h4 className="headingToken text-center">Risk Free Value (RFV)</h4>
                <p className="text-center mt-4 text-white">5% of order fees are stored in SAP</p>
              </div>
            </div>
            <h2 className="line text-white">$SAFTI</h2>
            <div className="row m-3">
              <div class="col-sm-5 my-auto">
                <h4 className="text-center headingToken">Treasury</h4>
              ...
              <div className="col-sm-5 flex-column justify-content-center d-flex">
                <h4 className="headingToken text-center">Treasury</h4>
                <p className="text-center mt-4 text-white">2.5% of order fees go to the treasury</p>
              </div>
            </div>
            <h2 className="line text-white">$SAFTI</h2>
            <div className="row m-3">
              <div class="col-sm-5 my-auto">
                <h4 className="text-center headingToken">Automated Supply Control (ASC)</h4>
              ...
              <div className="col-sm-5 flex-column justify-content-center d-flex">
                <h4 className="headingToken text-center">Automated Supply Control (ASC)</h4>
                <p className="text-center mt-4 text-white">2.5% of $SAFTI is burnt in the fire pit</p>
              </div>
            </div>
          </div>
